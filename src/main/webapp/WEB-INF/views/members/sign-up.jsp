...
<body>
    ...
    <script>
        ...
        // 입력값 검증 통과 여부 배열
        const checkReusltList = [false, false, false, false, false];        
                ...
                fetch('/members/check?type=account&keyword=' + idValue)
                    ...
                    .then(flag => {
                        if (flag) {
                            ...
                            document.getElementById('idChk').innerHTML 
                                = '<b style="color:skyblue">[사용가능한 아이디 입니다.]</b>';
                            checkReusltList[0] = true;
                        }
                    })
        ...
        document.getElementById('signup-btn').onclick = e => {
            ...
            // 5개의 입력칸이 모두 통과 되었을 경우 폼을 서브밋
            const $form = document.getElementById('signUpForm');

            if (!checkReusltList.includes(false)) {
                $form.submit();
            } else {
                alert('입력란을 다시 확인하세요!');
            }
