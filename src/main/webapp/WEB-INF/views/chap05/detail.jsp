                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3">
                        <div class="form-group">
                           ...
                           <input id="newReplyWriter" name="replyWriter" type="text" value="${loginUser.name}"
      ...
      function replyRemoveClickEvent() {
         ...
         $replyData.onclick = e => {
            ...
            if (e.target.matches('#replyDelBtn')){
               ...
               // 수정 완료 처리를 위해 수정창을 띄울 때 모달에 댓글 번호를 붙여 놓기
