...
<body>
                ...
                <div class="card-wrapper">
                    <section class="card">
                        <div class="card-title-wrapper" onclick="window.location.href='/board/detail?boardNo=${b.boardNo}'">
                            <h2 class="card-title">${b.reduceTitle}</h2>
                    ...
                    <div class="card-btn-group">
                        <button class="del-btn" onclick="window.location.href='/board/delete?boardNo=${b.boardNo}'">
    ...
    <script>
        ...
        $cardContainer.onmouseover = e => {
            ...
            // $delBtn.onclick = e => {
            //     // alert("삭제 클릭");
            //     window.location.href = "/board/delete?boardNo"
            // }
        }
