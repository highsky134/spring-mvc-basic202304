...
public class FileUtil {
     ...
     *           (ex: /2023/05/16/djqfhem_vkdlf.jpg)
     */
    public static String uploadFile(
            MultipartFile file, String rootPath) {

        // 원본 파일명을 중복이 없는 랜덤 이름으로 변경
        // ex) 상어.png -> gjklewvnlqwknklw-sjkrkw_상어.png
        String newFileName = UUID.randomUUID() + "_" + file.getOriginalFilename();

        // 이 파일을 저장할 날짜별 폴더를 생성
        // D:/spring-prj/upload/2023/05/16/asfjkacskas_상어.png
        ...
        // fullPath = D:/abc/upload/2023/05/16/asdsd.jpg
